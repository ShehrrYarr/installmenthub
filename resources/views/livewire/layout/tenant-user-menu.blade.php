...
new class extends Component
{
    ...
    public function logout(Logout $logout): void
    {
        ...
        // page, unless this was a "Try the Live Demo" session (see
        // landing.blade.php's enterAsDemo), which has no login of its own to
        // return to and instead goes back to the landing page itself.
        $shop = Tenant::current();
